...
protected:
	static void _bind_methods() {
        ...
        ClassDB::bind_method(D_METHOD("schedule_fade", "volume_start", "volume_end", "fade_length"), &ShinobuGodotSoundPlayback::schedule_fade);
        ...
        ClassDB::bind_method(D_METHOD("at_end"), &ShinobuGodotSoundPlayback::at_end);
...
public:
    ...
    void schedule_fade(float volume_start, float volume_end, uint64_t fade_length) {
        playback->schedule_fade(volume_start, volume_end, fade_length);
    }
